...
status: stable
since: 1.1.0
figma: "🧱 Template / box (691:3077)"
---

# Card 스펙

관련 콘텐츠를 하나의 시각 단위로 묶는 컨테이너. 결제 브리핑 요약, 거래 내역 항목, 설정 섹션 등 하나머니 앱의 기본 콘텐츠 블록.
...
| `elevated` | 목록에서 시선을 끌어야 하는 카드(결제 브리핑 등) | 테두리 유지 + 은은한 그림자로 강조 |
